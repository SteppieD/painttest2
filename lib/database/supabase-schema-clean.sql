-- Clean Supabase Schema for PaintQuoteApp
-- This version drops existing tables and recreates them
...
CREATE INDEX idx_companies_access_code ON public.companies(access_code);
...
SELECT 'Companies table created with ' || COUNT(*) || ' rows' as status FROM public.companies;
SELECT 'Quotes table created and ready' as status;