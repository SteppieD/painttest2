  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        {/* AI Quote Options - Basic and Premium */}
        <div className="mb-8 space-y-4">
          {/* Basic AI Quote Assistant */}
          <Card 
            className="cursor-pointer card-flat bg-blue-50 border-2 border-blue-300 hover:shadow-flat-lg transition-all duration-200 interactive-flat" 
            onClick={() => router.push("/create-quote-ai")}
          >
            <CardContent className="p-6 sm:p-8">
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-5">
                  <div className="w-20 h-20 bg-blue-500 rounded-flat-xl flex items-center justify-center shadow-flat">
                  ...
                  <div className="flex-1">
                    <h3 className="text-flat-2xl font-bold text-blue-600 mb-2">
                      AI Quote Assistant <span className="text-flat-sm bg-blue-100 text-blue-700 px-2 py-1 rounded-full ml-2">$2.70/1000</span>
                    </h3>
                    <p className="text-flat-lg font-medium text-flat-gray-700">Natural conversation • Understands contractor language • Powered by GPT-4o mini</p>
                  </div>
                </div>
          ...
          {/* Premium AI Quote Assistant */}
          <Card 
            className="cursor-pointer card-flat bg-gradient-to-r from-purple-50 to-blue-50 border-2 border-purple-300 hover:shadow-flat-lg transition-all duration-200 interactive-flat" 
            onClick={() => router.push("/create-quote-premium")}
          >
            <CardContent className="p-6 sm:p-8">
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-5">
                  <div className="w-20 h-20 bg-gradient-to-r from-purple-600 to-blue-600 rounded-flat-xl flex items-center justify-center shadow-flat">
                    <svg className="w-10 h-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
                  </div>
                  <div className="flex-1">
                    <h3 className="text-flat-2xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent mb-2">
                      Premium AI Assistant 
                      <span className="text-flat-sm bg-gradient-to-r from-purple-100 to-blue-100 text-purple-700 px-2 py-1 rounded-full ml-2">
                        ⚡ PREMIUM
                      </span>
                    </h3>
                    <p className="text-flat-lg font-medium text-flat-gray-700">
                      Multi-agent system • Business optimization • Market intelligence • Error detection
                    </p>
                    <div className="flex items-center gap-4 mt-2">
                      <span className="text-flat-sm text-purple-600 font-medium">$100/1000 quotes</span>
                      <span className="text-flat-sm text-gray-500">•</span>
                      <span className="text-flat-sm text-gray-600">5 AI specialists working together</span>
                    </div>
                  </div>
                </div>
                <div className="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">
                  <ArrowRight className="icon-flat-lg text-purple-600" />
                </div>
              </div>
            </CardContent>
          </Card>
