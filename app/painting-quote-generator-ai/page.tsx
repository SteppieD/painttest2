        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <Link href="/trial-signup" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md">Try AI Free</Link>
            </nav>
          </div>
        </div>
      </header>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">AI-powered painting quote generation for the modern contractor. Generate professional estimates in seconds.</p>
            </div>
            <div>
              <h3 className="font-semibold mb-4">AI Tools</h3>
              <ul className="space-y-2 text-gray-400">
                <li><Link href="/painting-estimate-calculator" className="hover:text-white">AI Calculator</Link></li>
                <li><Link href="/painting-quote-templates" className="hover:text-white">Smart Templates</Link></li>
                <li><Link href="/trial-signup" className="hover:text-white">Try AI Free</Link></li>
              </ul>
            </div>
            <div>
