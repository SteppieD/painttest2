          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <Link href="/trial-signup">
                <Button>Try Free Calculator</Button>
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">Professional painting quote software for contractors who want accurate estimates and increased profits.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><Link href="/how-to-quote-painting-jobs" className="hover:text-white">How to Quote Jobs</Link></li>
                <li><Link href="/painting-estimate-calculator-free" className="hover:text-white">Free Calculator App</Link></li>
                <li><Link href="/features" className="hover:text-white">Software Features</Link></li>
              </ul>
            </div>
            <div>
