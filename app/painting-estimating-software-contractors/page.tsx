        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">Professional painting estimating software for contractors who want to win more jobs and increase profits.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><Link href="/commercial-painting-estimating" className="hover:text-white">Commercial Estimating</Link></li>
              </ul>
            </div>
            <div>
