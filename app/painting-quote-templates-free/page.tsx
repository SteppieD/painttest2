          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <Link href="/trial-signup">
                <Button>Create Custom Quote</Button>
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">Professional painting quote templates and software for contractors who want to win more jobs and increase profits.</p>
            </div>
            <div>
              <h3 className="font-semibold mb-4">Templates</h3>
              <ul className="space-y-2 text-gray-400">
                <li><Link href="#templates" className="hover:text-white">Interior Templates</Link></li>
                <li><Link href="#templates" className="hover:text-white">Exterior Templates</Link></li>
                <li><Link href="#templates" className="hover:text-white">Commercial Templates</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="font-semibold mb-4">Resources</h3>
              <ul className="space-y-2 text-gray-400">
                <li><Link href="/how-to-quote-painting-jobs-professionally" className="hover:text-white">How to Quote</Link></li>
                <li><Link href="/painting-estimate-calculator" className="hover:text-white">Quote Calculator</Link></li>
                <li><Link href="/painting-estimating-software" className="hover:text-white">Software Features</Link></li>
              </ul>
            </div>
            <div>
